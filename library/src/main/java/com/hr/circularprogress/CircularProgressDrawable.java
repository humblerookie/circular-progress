...
import static com.hr.circularprogress.Utils.*;
...
public class CircularProgressDrawable
    ...
    private CircularProgressDrawable(PowerManager powerManager, Options options) {
        ...
        if (mOptions.shouldUseGradient) {
            mPaint.setShader(new LinearGradient(0, 0, 0, 100, mOptions.gradientStartColor, mOptions.gradientEndColor, Shader.TileMode.MIRROR));
        } else {
    ...
    public static class Builder {
        ...
        private boolean mShouldUseGradient;
        ...
        public Builder gradientStart(int gradientStart) {
            mGradientStart = gradientStart;
            mShouldUseGradient = true;
            return this;
        }

        public Builder gradientEnd(int gradientEnd) {
            mGradientEnd = gradientEnd;
            mShouldUseGradient = true;
            return this;
        }

        public Builder gradientHeight(int gradientHeight) {
